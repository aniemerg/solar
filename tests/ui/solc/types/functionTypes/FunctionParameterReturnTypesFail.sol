...
abstract contract Test
{
    ...
    {
      function (uint256) internal pure returns (uint256) var_uint256_to_uint256 = uint256_to_string; //~ ERROR: mismatched types
      function (uint256) internal pure returns (string memory) var_uint256_to_string = uint256_to_string_storage; //~ ERROR: mismatched types
      function (string memory) internal pure returns (uint256) var_string_to_uint256 = uint256_to_string; //~ ERROR: mismatched types
      function (string memory) internal pure returns (string memory) var_string_to_string = var_uint256_to_string; //~ ERROR: mismatched types

      function (uint256, uint256) internal pure returns (uint256) var_uint256_uint256_to_uint256 = uint256_to_uint256; //~ ERROR: mismatched types
      function (string memory, uint256) internal pure returns (string memory) var_string_uint256_to_string = string_to_string; //~ ERROR: mismatched types
      function (string memory, string memory) internal pure returns (string memory) var_string_string_to_string = string_to_string; //~ ERROR: mismatched types

      var_uint256_to_uint256(1);
      var_uint256_to_string(2);
      var_string_to_uint256("a"); //~ ERROR: mismatched types
      var_string_to_string("b"); //~ ERROR: mismatched types
      var_uint256_uint256_to_uint256(3, 4);
      var_string_uint256_to_string("c", 7); //~ ERROR: mismatched types
      var_string_string_to_string("d", "e"); //~ ERROR: mismatched types
