...
import "../src/HomerInterfaceId.sol";

contract HomerInterfaceIdTest {
    function test_HomerInterfaceId() public {
        HomerInterfaceId c = new HomerInterfaceId();
        // left(0x01ffc9a0) -> false
        assert(c.supportsInterface(0x01ffc9a0) == false);
        // left(0x01ffc9a7) -> true  (ERC165 interfaceId)
