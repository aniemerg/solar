...
import "../src/CalldataToStorage.sol";

contract CalldataToStorageTest {
    function test_structCalldata() public {
        CalldataToStorage c = new CalldataToStorage();
    ...
    function test_smallArray() public {
        ...
        assert(Small.unwrap(result[2]) == 3);
