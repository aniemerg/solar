...
contract ComparisonOperatorForExternalFunctionCleansDirtyBits {
    function g() external {}

    function comparison_operators_for_external_function_pointers_with_dirty_bits() external view returns (bool) {
