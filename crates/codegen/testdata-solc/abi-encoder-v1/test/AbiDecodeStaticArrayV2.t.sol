...
import "../src/AbiDecodeStaticArrayV2.sol";

// Ported from: abiEncoderV1/abi_decode_static_array_v2.sol
// f(bytes): 0x20, 0xc0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6 -> 1, 2, 3, 4, 5, 6
contract AbiDecodeStaticArrayV2Test is Test {
    AbiDecodeStaticArrayV2 c;

    function setUp() public {
        c = new AbiDecodeStaticArrayV2();
    }
