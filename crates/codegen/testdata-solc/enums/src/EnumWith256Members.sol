...
contract EnumWith256Members {
    function getMinMax() public pure returns (E, E) {
        return (E.E000, E.E255);
    }

    function intToEnum(uint8 _i) public pure returns (E) {
        return E(_i);
    }

    function enumToInt(E _e) public pure returns (uint8) {
        return uint8(_e);
    }

    function decodeEnum(bytes memory data) public pure returns (E) {
