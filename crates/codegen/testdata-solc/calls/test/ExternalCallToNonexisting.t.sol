...
import "../src/ExternalCallToNonexisting.sol";

contract ExternalCallToNonexistingTest is Test {
    ExternalCallToNonexisting c;

    function setUp() public {
        c = new ExternalCallToNonexisting{value: 1 ether}();
    }
