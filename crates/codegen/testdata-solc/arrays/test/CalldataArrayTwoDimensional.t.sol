...
import "../src/CalldataArrayTwoDimensional.sol";

contract CalldataArrayTwoDimensionalTest is Test {
    CalldataArrayTwoDimensional c;

    function setUp() public {
        c = new CalldataArrayTwoDimensional();
    }

    function makeArray() internal pure returns (uint256[][2] memory) {
        uint256[][2] memory a;
        a[0] = new uint256[](3);
    ...
    function test_CalldataArrayTwoDimensional() public {
        uint256[][2] memory a = makeArray();
