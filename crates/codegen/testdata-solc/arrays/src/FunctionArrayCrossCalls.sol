...
contract FunctionArrayCrossCallsD {
...
contract FunctionArrayCrossCalls {
    function runTest() public returns (uint256, uint256, uint256) {
        ...
        x[0] = this.htwo;
        function() external returns (uint)[3] memory y = (new FunctionArrayCrossCallsD()).f(x);
        return (y[0](), y[1](), y[2]());
    }
